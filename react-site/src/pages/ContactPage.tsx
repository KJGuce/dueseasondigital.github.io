...
const ContactPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contact Due Season Digital — Get Your AI Search Visibility
          Consultation
        </title>
        <meta
          name="description"
          content="Ready to boost your AI assistant recommendations? Contact us today for a free GEO consultation and start growing your digital presence the smart way."
        />
      </Helmet>
      <div className={styles.contactPage}>
        ...
        <section className={styles.hero}>
          <div className={styles.container}>
            ...
            >
              We'd love to hear about your business and how we can help you
              stand out in local and AI-powered search.
            </motion.p>
          </div>
        </section>
        ...
        <section className={styles.brandQuote}>
          <div className={styles.container}>
            <motion.blockquote
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              "We believe small businesses deserve big visibility. Let's start
              the conversation."
            </motion.blockquote>
          </div>
        </section>
